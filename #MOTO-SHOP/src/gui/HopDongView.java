...
public class HopDongView extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HopDongView frame = new HopDongView();
	 ...
	 */
	public HopDongView() {
		setTitle("PHẦN MỀM QUẢN LÝ CỬA HÀNG XE MÁY - HỢP ĐỒNG");
		...
		JButton btnHopDong = new JButton("HỢP ĐỒNG");
        ...
        FlowLayout flowLayout = (FlowLayout) pHopDong.getLayout();
        tabbedPane.addTab("Hợp Đồng", null, pHopDong, null);
