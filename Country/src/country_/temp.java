...
public class temp extends JFrame implements ActionListener, MouseListener {
	...
	private void createGui() {
		...
		JLabel lblTt = new JLabel("USING JTABLE COMPONENT");
		...
		String[] col = { "Country", "Capital", "Population", "Democracy"};
